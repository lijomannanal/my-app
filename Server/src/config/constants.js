export const COFFEE_URL = 'https://api.sampleapis.com/coffee/hot';
export const BEER_URL = 'https://api.sampleapis.com/beers/ale';
export const DRINK_TYPES = {
    'COFFEE': 'coffee',
    'BEER': 'beer'
};
export const COFFEE_IMAGE_URL = 'https://coffee.alexflipnote.dev/random.json';

export const BEER_DESCRIPTION = {
...
export const UUID_REGEX = '^UI[a-zA-Z0-9]{7}$';